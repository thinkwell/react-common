    ...
    CKEDITOR.plugins.add('ckeditor_wiris', {
        'init': function (editor) {
            ...
            editor.on('instanceReady', function () {
                ...
                ckeditorIntegrationModelProperties.serviceProviderProperties.URI = '/wirispluginengine/integration/';
                ckeditorIntegrationModelProperties.serviceProviderProperties.server = 'ruby';
