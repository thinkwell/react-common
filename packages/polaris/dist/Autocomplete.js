...
export default function Autocomplete(props) {
    ...
    const textField = (_jsx(AutocompletePolaris.TextField, { autoComplete: '', onChange: updateText, value: inputValue, label: props.label, clearButton: true, onClearButtonClick: onClearButtonClick, prefix: _jsx(Icon, { source: SearchIcon, tone: "base" }), placeholder: props.placeholder || `Search ${props.label}` }));
