...
export default function MainFrame(props) {
    ...
    const topBarMarkup = (props.userMenu || searchFieldMarkup || props.showNavigationToggle) ? (_jsx(TopBar, { showNavigationToggle: props.showNavigationToggle, userMenu: props.userMenu, searchResultsVisible: props.searchResultsVisible, searchField: searchFieldMarkup, searchResults: props.searchResults, onSearchResultsDismiss: props.onSearchResultsDismiss, onNavigationToggle: toggleMobileNavigationActive })) : null;
